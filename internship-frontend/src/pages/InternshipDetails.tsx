      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="retro-panel mb-6 overflow-hidden animate-fade-in-up">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, rgba(0,60,150,0.3) 0%, rgba(80,0,150,0.3) 100%)' }}
          >
                ...
                {[
                  ...
                  <div key={label} className="p-3" style={{ background: 'rgba(0,0,20,0.5)', border: '1px solid rgba(0,243,255,0.1)' }}>
                    ...
                    <p className="font-['Share_Tech_Mono'] text-sm text-white">
                      {new Date(date as string).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="retro-panel p-6">
              ...
              {applied ? (
                <div className="text-center py-4">
                  <div
                    className="w-12 h-12 mx-auto mb-3 flex items-center justify-center border"
        ...
        >
          <div className="retro-modal" style={{ maxWidth: '480px' }}>
            ...
            <div className="p-6">
              ...
              <div
                className="relative mb-5 p-8 text-center"
                style={{
